        ...
        <FadeInUp>
          <div className="grid gap-5">
            ...
            <span className=" text-gray-500 text-xl font-normal font-['Sen'] leading-[30px]">
              Stay updated on the sea and seafood industries with the latest
              news.
            </span>
          </div>
        </FadeInUp>
              ...
              <div className="lg:hidden block mb-12">
                <Listbox
                  ...
                  <div className="relative mt-1">
                    <Listbox.Button className="relative w-full cursor-default rounded-lg border bg-white py-2 pl-3 pr-10 text-left focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm  border-gray-300 shadow">
          ...
          {searchInput == "" ? (
            ...
            <div className="lg:w-3/4 lg:m-0  w-full">
              ...
              {filteredData.length === 0 ? (
                <div className="w-full h-[300px] flex items-center justify-center ] text-gray-500 text-md font-normal font-['Sen'] leading-[30px] ">
                  {" "}
                  Article Not Found
                </div>
              ) : null}
